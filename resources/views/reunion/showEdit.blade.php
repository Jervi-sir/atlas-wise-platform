...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Reunion Edit</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Home</a>
                        </li>
                        <li class="breadcrumb-item active">Reunion Edit
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" action="{{ route('reunion.update') }}" method="POST">
                            @csrf
                            <input type="hidden" name="reunion_id" value="{{ $item->id }}">
                                    ...
                                    <div class="col-12">
                                        <select name="members[]" class="select2 form-control" multiple="multiple" id="default-select-multi" >
                                            @foreach (\App\Models\User::all() as $user)
                                                <option value="{{ $user->id }}"  {{ $user->invited_to_reunion()->find($item->id) ? 'selected' : '' }}>{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
