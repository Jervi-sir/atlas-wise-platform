...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Reunion Show</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Home</a>
                        </li>
                        <li class="breadcrumb-item active">Reunion Show
                        </li>
                    </ol>
                </div>
            </div>
...
<div class="content-body">
    @include('reunion.alert')
    <!-- Validation -->
    <section class="bs-validation">
        <div class="row">
            <!-- Bootstrap Validation -->
            @if($reunions->count() == 0)
                <h2>No Reunion created</h2>
            @endif
            ...
            <div class="col-md-4 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" action="{{ route('reunion.updateshow') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input  type="text" id="basic-addon-name" class="form-control" placeholder="Name" aria-label="Name" aria-describedby="basic-addon-name" value="{{ $reunion->name }}" disabled />
                            </div>

                            <!-- date -->
                            <div class="form-group">
                                <label for="account-birth-date">Date</label>
                                <input  type="text" class="form-control flatpickr" placeholder="Date" id="account-birth-date" value="{{ $reunion->date }}" disabled/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-12 px-0">
                                    <ul class="invited-disabled" dir="ltr" style="width: 100%;" disabled>
                                        @foreach ($reunion->invited()->get() as $user)
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="validationBioBootstrap" rows="3" disabled>{{ $reunion->description }}</textarea>
                            </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>
                                    Are you sure you want to delete this " {{ $reunion->name }} "
                                </p>
                            </div>
                            <div class="modal-footer">
                                <form action="{{ route('reunion.delete') }}" method="POST" class="mr-5">
                                    @csrf
                                    <input type="hidden" name="reunion_id" value="{{ $reunion->id }}">
