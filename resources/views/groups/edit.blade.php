            ...
            <div class="col-md-6 col-12 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit my group</h4>
                    </div> 
                    ...
                    @else
                    <div class="card-body">
                        <form class="needs-validation" action="{{ route('group.edit') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label class="form-label" for="basic-addon-name">Group name</label>
                                <input name="group-name" type="text" id="basic-addon-name" class="form-control" value="{{ $group->name }}" aria-label="Name" aria-describedby="basic-addon-name" required />
                            </div>

                            <div class="form-group">
                                <label class="d-block" for="validationBioBootstrap">Description</label>
                                <textarea name="description" class="form-control" id="validationBioBootstrap" name="validationBioBootstrap" rows="3" required>{{ $group->description }}</textarea>
                            </div>
