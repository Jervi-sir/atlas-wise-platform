...
<!-- BEGIN: Page CSS-->
<link rel="stylesheet" type="text/css" href="../../../app-assets/css/core/menu.css">
...
<style>
    .card-reunion {
        ...
        background-image: linear-gradient(178deg, #000000 0%, #414141 74%);
    }
    ...
    .shadow-2 {
        border-radius: 50px;
        background: #414141;
        box-shadow:  20px 20px 60px #373737,
                    -20px -20px 60px #4b4b4b;
    }
